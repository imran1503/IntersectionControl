...
class DatasetHandler:
    ...
    def _read_image(self):
        im_name = self.image_dir + '/' + str(self.initialValue+self.current_frame) + '001.png'
        self.image = cv2.imread(im_name)[:, :, ::-1]

    def _read_depth(self):
        depth_name = self.depth_dir + '/' + str(self.initialValue+self.current_frame) + '001.png'
        self.depth = cv2.imread(depth_name)[:, :, ::-1]

    def _read_segmentation(self):
        seg_name = self.segmentation_dir + '/' + str(self.initialValue+self.current_frame) + '001.png'
        self.segmentation = cv2.imread(seg_name)[:, :, ::-1]
